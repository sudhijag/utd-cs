...
Original file is located at
    https://colab.research.google.com/drive/1-ZPfYhHdrIEJ6nrlzPKFedrT5SWO3m4E
"""
...
print("---train")
model = svm.SVC(C=10, degree= 3, gamma= 0.02, coef0= 0.4,  kernel= "poly") # this line should be changed
