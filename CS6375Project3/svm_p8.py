...
Original file is located at
    https://colab.research.google.com/drive/15auurAWn9O-Hupaj0lC2sayUwaPunQEg
"""
...
print("---train")
model = svm.SVC(C=10, degree= 3, gamma= 0.01, coef0=0.4, kernel= "poly") # this line should be changed
