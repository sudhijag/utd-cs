# -*- coding: utf-8 -*-
"""MiniMaxOpeningAB.ipynb

Automatically generated by Colaboratory.

Original file is located at
    https://colab.research.google.com/drive/14aiHD4ZS_8xXo5GBaOvuA-mwg8E4tPMy
"""
...
#@title MINIMAXOPENINGAB
def miniMaxOpeningAB(tree, maxdepth, isMaximizing, currentdepth, alpha, beta):
  ...
  if (currentdepth == maxdepth):
    ...
    if (isMaximizing):
      ...
      for child in tree.children:
        print("HI3")
        childeval= miniMaxOpeningAB(child, maxdepth, not (isMaximizing), currentdepth + 1, alpha, beta)
...
evals=miniMaxOpeningAB(root, depth, True, 0, -99999, 99999) #tree, max, ismax, curr
